...
class HDMapNetEvalDataset(HDMapNetDataset):
    def __init__(self, nusc, version, dataroot, eval_set, result_path, data_conf, max_line_count=300):
        self.eval_set = eval_set
        super(HDMapNetEvalDataset, self).__init__(nusc, version, dataroot, data_conf, is_train=False)
